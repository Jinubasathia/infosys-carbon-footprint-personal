...
public class UserDashboardController {
    ...
    @GetMapping("/summary")
    public ApiResponse<UserDashboardSummaryDto> summary(@AuthenticationPrincipal UserDetailsImpl user) {
        return ApiResponse.success("Dashboard summary fetched", service.getSummary(user.getId()));
    }
}
